    ...
    SettingsPage.prototype.testNotifications = function (notificationType) {
        ...
        if (notificationType === "Azan A") {
            ...
            cordova.plugins.notification.local.schedule({
                ...
                sound: 'file://assets/audio/Azan-A.mp3',
                priority: 1,
                channelParams: { channelID: "test1", channelName: "test1", description: "channel_description", importance: 5 }
            });
            channel = "test2";
        }
            ...
            cordova.plugins.notification.local.schedule({
                ...
                sound: 'file://assets/audio/Azan-S.mp3',
                priority: 1,
                channelParams: { channelID: "test2", channelName: "test2", description: "channel_description", importance: 5 }
            });
        }
        else {
            cordova.plugins.notification.local.schedule({
                ...
                smallIcon: 'res://small_icon',
                priority: 1,
                channelParams: { channelID: "test3", channelName: "test3", description: "channel_description", importance: 5 }
            });
        }
        /*
    ...
    PrayerPage.prototype.generateMqttNotification = function (latestSalatTimeId) {
        ...
        this.storage.get("latestSalatTimeId").then(function (id) {
            if (id !== latestSalatTimeId) {
                ...
                setTimeout(function () { alert("An update to your Salat times has been made."); }, 500);
            }
            else {
                //is an announcement
                _this.localNotifications.schedule({
                ...
                setTimeout(function () { alert("A new announcement has been made."); }, 500);
            }
            _this.storage.set("latestSalatTimeId", latestSalatTimeId);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_feedback_feedback__ = __webpack_require__(116);
