            ...
            for (var _i = 0, prayerTimes_1 = prayerTimes; _i < prayerTimes_1.length; _i++) {
                ...
                if (prayer.prayerName === "Fajar" && (_this.settings && _this.settings.sound !== "default")) {
                    if (_this.platform.is('android')) {
                        ...
                        sound = 'file://assets/audio/Azan-IOS.caf';
                    }
                }
...
var SettingsPage = /** @class */ (function () {
    function SettingsPage(navCtrl, navParams, events, authProvider, storage, alertCtrl, localNotifications, platform) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.events = events;
    ...
    SettingsPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["c" /* Events */], __WEBPACK_IMPORTED_MODULE_2__providers_authentication_authentication__["a" /* AuthenticationProvider */], __WEBPACK_IMPORTED_MODULE_3__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_local_notifications__["a" /* LocalNotifications */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* Platform */]])
    ], SettingsPage);
    return SettingsPage;
}());
