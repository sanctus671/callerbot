...
var PrayerPage = /** @class */ (function () {
    ...
    PrayerPage.prototype.generateNotifications = function () {
        ...
        for (var _i = 0, _a = this.prayerTimes; _i < _a.length; _i++) {
            ...
            this.localNotifications.getAllScheduled().then(function (data) {
                console.log(data);
            });
